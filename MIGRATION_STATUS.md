...
## Log
- 2026-07-22: P4.4 final cutover validation PASSED on develop tip post-GSP-removal (API snapshots 173/191 w/ only 18 documented pre-existing source-build failures; contract 868 pass/1 documented pre-existing; full Playwright green; manual flows + legacy URLs OK; fresh DB 982/982 changesets). MIGRATION COMPLETE: Phases 0-4 all done.
...
- 2026-07-22: #71 (B46) merged. 49/49 Phase 2 batches done — Phase 2 COMPLETE. Launching Phase 4 (regression, Liquibase dry-run, perf smoke, GSP/dead-code removal, cutover validation).
...
- 2026-07-22: #64 (B44) merged. 42/49 Phase 2 batches done. B42 + wave 8 (B45-B49) in flight.
- 2026-07-22: #70 (B41) merged. 41/49 Phase 2 batches done. B42/B44 finishing; wave 8 (B45-B49) in flight.
