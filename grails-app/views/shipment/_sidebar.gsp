		...
		<div class="actions">
			<g:if test="${shipmentInstance?.origin?.id == session.warehouse.id}">
				<div class="action-menu-item">
					<g:link controller="shipment" action="list">
						<img src="${resource(dir:'images/icons/silk',file:'lorry.png')}" style="vertical-align: middle" />&nbsp;
			...
			<div class="action-menu-item">
				<g:link controller="shipment" action="showDetails" id="${shipmentInstance.id}">
					<img src="${resource(dir:'images/icons/silk',file:'zoom.png')}" alt="Show Details" style="vertical-align: middle" />&nbsp;
			...
			<div class="action-menu-item">
				<a href="${createLink(controller: "shipment", action: "addDocument", id: shipmentInstance.id)}">
					<img src="${resource(dir:'images/icons/silk',file:'page_add.png')}" alt="Upload a Document" style="vertical-align: middle"/>&nbsp;<warehouse:message code="shipping.uploadADocument.label"/></a>
			</div>
			<div class="action-menu-item">
				<a href="${createLink(controller: "shipment", action: "addComment", id: shipmentInstance.id)}">
					<img src="${resource(dir:'images/icons/silk',file:'note_add.png')}" alt="Add Note" style="vertical-align: middle"/>&nbsp;<warehouse:message code="shipping.addNote.label"/></a>
			</div>
			<div class="action-menu-item">
				<hr/>
			</div>
			...
			<div class="action-menu-item">
				<g:link controller="shipment" action="showPackingList" id="${shipmentInstance.id}">
					<img src="${resource(dir:'images/icons/silk',file:'page.png')}" alt="View Packing List" style="vertical-align: middle"/>&nbsp;
			...
			<div class="action-menu-item">
				<g:link controller="doc4j" action="downloadPackingList" id="${shipmentInstance?.id }">
					<img src="${resource(dir:'images/icons/silk',file:'page_white_excel.png')}" alt="View Packing List" style="vertical-align: middle"/>&nbsp;
				...
				<div class="action-menu-item">
					<g:if test="${!shipmentInstance?.hasShipped()}">
						<g:link controller="shipment" action="sendShipment" id="${shipmentInstance.id}">
							<img src="${resource(dir:'images/icons',file:'truck.png')}" alt="Send Shipment" style="vertical-align: middle" />&nbsp;
				...
				<div class="action-menu-item">
					<g:if test="${shipmentInstance.hasShipped() && !shipmentInstance.wasReceived()}">
						<g:link controller="shipment" action="receiveShipment" params="${ [shipmentId : shipmentInstance.id] }">
							<img src="${resource(dir:'images/icons',file:'handtruck.png')}" alt="Receive Shipment" style="vertical-align: middle" />&nbsp;
			...
			<g:if test="${session?.warehouse?.id == shipmentInstance?.origin?.id ||
				...
				<div class="action-menu-item">
					...
					src="${resource(dir:'images/icons',file:'trash.png')}"
