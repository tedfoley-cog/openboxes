import { ATTRIBUTE_API, ATTRIBUTE_BY_ID, UNIT_OF_MEASURE_CLASS_OPTIONS } from 'api/urls';
import apiClient from 'utils/apiClient';

export default {
  searchAttributes: (config) => apiClient.get(ATTRIBUTE_API, config),
  getAttribute: (id) => apiClient.get(ATTRIBUTE_BY_ID(id)),
  createAttribute: (payload) => apiClient.post(ATTRIBUTE_API, payload),
