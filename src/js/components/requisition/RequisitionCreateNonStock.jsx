...
const RequisitionCreateNonStock = () => {
  const location = useLocation();
  const type = queryString.parse(location.search)?.type || 'NON_STOCK';
    ...
    <div className="d-flex flex-column m-3">
      <div className="card">
        <div className="card-header">
          <Translate id="react.requisition.newNonStock.label" defaultMessage="New Non-Stock Requisition" />
        </div>
...
export default RequisitionCreateNonStock;
