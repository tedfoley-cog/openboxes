...
const ShipmentAddDocument = () => {
  ...
  useEffect(() => {
    ...
    shipmentApi.getDocumentTypeOptions()
      .then(({ data }) => {
        ...
        <form className="card-body" onSubmit={submit}>
          ...
          <div className="form-group row">
            <label className="col-sm-3 col-form-label" htmlFor="document-name-input">
              <Translate id="react.shipment.document.name.label" defaultMessage="Name" />
            </label>
            <div className="col-sm-6">
              <input
                type="text"
          ...
          <div className="form-group row">
            <label className="col-sm-3 col-form-label" htmlFor="document-url-input">
              <Translate id="react.shipment.document.url.label" defaultMessage="URL" />
            </label>
            <div className="col-sm-6">
              <input
                type="text"
...
export default ShipmentAddDocument;
