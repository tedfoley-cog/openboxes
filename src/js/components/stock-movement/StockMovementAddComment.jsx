...
const StockMovementAddComment = () => {
  ...
  const submit = async (event) => {
    ...
    setSaving(true);
    try {
      await stockMovementApi.createComment(stockMovementId, {
        comment,
        ...
        <form className="card-body" onSubmit={submit}>
          ...
          <div className="form-group row">
            <label className="col-sm-3 col-form-label" htmlFor="comment-text-input">
              <Translate id="react.stockMovement.comment.comment.label" defaultMessage="Comment" />
            </label>
            <div className="col-sm-6">
              <textarea
...
export default StockMovementAddComment;
