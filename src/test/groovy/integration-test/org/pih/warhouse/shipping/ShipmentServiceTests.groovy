...
class ShipmentServiceTests extends Specification implements ServiceUnitTest<ShipmentService>, DataTest {
    ...
    Class[] getDomainClassesToMock() {
        [Category, Product, ShipmentType, Location, ContainerType, Shipment, ShipmentItem]
    }
...
//        service.saveShipment(shipment3)
    ...
    void test_moveContainer_shouldMoveContainerToShipment() {
        ...
        when:
        service.moveContainer(pallet1, shipment2)
    ...
    void test_deleteShipment_shouldCascadeDeleteContainers() {
        ...
        when:
        service.deleteShipment(shipment1)
    ...
    void test_deleteShipment_shouldCascadeDeleteShipmentItems() {
        ...
        service.deleteShipment(testShipment)
    ...
    void test_deleteContainer_shouldDeleteContainerButNotShipmentItems() {
        ...
        def numberOfShipmentItemsBeforeDelete = ShipmentItem.count()
        def numberOfContainersBeforeDelete = Container.count()
        service.deleteContainer(pallet1)
